...
// Vigenere_encrypt.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVigenereencryptApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVigenereencryptApp

CVigenereencryptApp::CVigenereencryptApp()
{
...
// Единственный объект CVigenereencryptApp

CVigenereencryptApp theApp;


// Инициализация CVigenereencryptApp

BOOL CVigenereencryptApp::InitInstance()
{
